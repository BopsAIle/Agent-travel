...
4. Never violate hard_constraints. Use soft_preferences as tie-breakers and follow priorities_highest_first when ranking events.
5. Put the curated list in options. selected_index is the single best match.
6. Write durable facts only (genre / event-style prefs). Never this trip's dates or a specific ticket.
